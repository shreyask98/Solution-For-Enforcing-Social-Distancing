...
root.title("Digital Solution For Enforcing Social Distancing")
...
#
label_l1 = tk.Label(root, text="Digital Solution For Enforcing Social Distancing",font=("Times New Roman", 35, 'bold'),
