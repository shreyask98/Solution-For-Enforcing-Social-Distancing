        ...
        for i in flat_box:
            ...
            if status[index] == True:
              ...
              #  from time import sleep
                myobj = gTTS(text="No Social Distancing maintained", lang="en", slow=False)
               ...
               # sleep(3)
                ...
                import os
               # from time import sleep
                myobj = gTTS(text="Social Distancing maintained", lang="en", slow=False)
                myobj.save("welcome.mp3")
                os.system("welcome.mp3")
               # sleep(3)
            index += 1
...
while(True):
    ...
    current_img = imutils.resize(current_img, width=800)
